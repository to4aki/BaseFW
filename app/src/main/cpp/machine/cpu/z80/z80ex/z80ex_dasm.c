...
#include "machine/cpu/z80/z80ex/include/z80ex_dasm.h"
...
#include "machine/cpu/z80/z80ex/opcodes/opcodes_dasm.c"
...
LIB_EXPORT int
z80ex_dasm(char *output, int output_size, unsigned flags, int *t_states, int *t_states2,
            ...
            switch (*mpos) {
                ...
                case '%':
                    ...
                    if (*mpos == '$')
                        ...
                        arglen = snprintf(stmp, STMP_SIZE, words_format,
                                          (int) ((Z80EX_WORD) (addr + disp)));
